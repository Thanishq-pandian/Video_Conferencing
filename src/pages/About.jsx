    ...
    <>
      <div className="about">
        ...
        <div className="about-text">
          <h1 className="about-heading">About Conferenza</h1>
          <p className="about-para">
            Conferenza is an all-in-one intelligent collaboration platform that
            makes connecting easier, more immersive, and more dynamic for
            businesses and individuals. Conferenza technology puts people at the
